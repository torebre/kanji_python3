...
weightsInit = tf.random_normal(
    shape=(1, caps1NumberOfCapsules, caps2NumberOfCapsules, caps2NumberOfDimensions, caps1NumberOfDimensions))
...
caps2OutputRound1Tiled = tf.tile(caps2OutputRound1, [1, caps1NumberOfCapsules, 1, 1, 1],
...
reconstructionMaskReshaped = tf.reshape(reconstructionMask, [-1, 1, caps2NumberOfCapsules, 1, 1],
                                        name="reconstruction_mask_reshaped")

caps2OutputMasked = tf.multiply(caps2Output, reconstructionMaskReshaped, name="caps2_output_masked")

decoderInput = tf.reshape(caps2OutputMasked, [-1, caps2NumberOfCapsules * caps2NumberOfDimensions],
                          name="decoder_input")
...
with tf.Session() as sess:
    ...
    print
    "Test24: ", numberOfEpochs

    for epoch in range(numberOfEpochs):
        startOfNextMiniBatch = 0

        print
        "Test25: ", numberOfIterationsPerEpoch
